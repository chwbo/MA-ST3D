...
# CLASS_MAPPING = {'car': ['car'], 'pedestrian': ['pedestrian'], 'cyclist': ['motorcycle', 'bicycle']}
class NuScenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        root_path = (root_path if root_path is not None else Path(dataset_cfg.DATA_PATH)) / dataset_cfg.VERSION
        # add by cwb 2022/06/20
        # class_names = CLASS_MAPPING[class_names[0]]
        super().__init__(
    ...
    def kitti_eval_ps(self, eval_ps_annos, eval_gt_annos, class_names):
        ...
        for gt_anno in eval_gt_annos:
            ...
            dt_anno['name'] = np.array(['car'] * dt_anno['gt_boxes'].shape[0])
