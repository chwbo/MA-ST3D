...
def main():
    ...
    with torch.no_grad():
        if args.eval_all:
            repeat_eval_ckpt_saved(model, test_loader, args, eval_output_dir, logger,
                             ckpt_dir, dist_test=dist_test, state_name=state_name)
        else:
            eval_single_ckpt_saved(model, test_loader, args, eval_output_dir, logger,
